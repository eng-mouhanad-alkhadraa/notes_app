      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          ListTile(
            title: Text(
              note.title,
              style: const TextStyle(color: Colors.black, fontSize: 26),maxLines: 1,
            ...
            subtitle: Padding(
              ...
              child: Text(
                note.subTitle,
                style: TextStyle(
                    color: Colors.black.withOpacity(.5), fontSize: 18),maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ),
            trailing: IconButton(
              onPressed: () {
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return DeleteConfirmationDialog(note: note);
                  },
                );
              },
              icon: const Icon(
